...
import com.tequila.brewer.model.Grupo;
import com.tequila.brewer.model.Usuario;
import com.tequila.brewer.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries {
	...
	public Optional<Usuario> porEmailEAtivo(String email) {
		return manager
				.createQuery("from Usuario where lower(email) = lower(:email) "
						+ "and ativo = true", Usuario.class)
