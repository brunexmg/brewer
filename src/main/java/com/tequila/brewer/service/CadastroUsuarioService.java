...
import com.tequila.brewer.service.exception.ImpossivelExcluirUsuarioException;
...
public class CadastroUsuarioService {
	...
	public void excluir(Usuario usuario) {
		try {
			...
			throw new ImpossivelExcluirUsuarioException("Impossível excluir usuário. Possui vendas já executadas!");
		}
	}
