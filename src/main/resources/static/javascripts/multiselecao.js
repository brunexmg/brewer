...
Brewer.MultiSelecao = (function() {
	...
	MultiSelecao.prototype.iniciar = function() {
		this.statusBtn.on('click', onStatusBtnClidado.bind(this));
	...
	function onStatusBtnClidado(event) {
	...
	function onSelecaoClicado() {
		var selecaoCheckboxChegados = this.selecaoCheckbox.filter(':checked');
		this.selecaoTodosCheckbox.prop('checked', selecaoCheckboxChegados.length >= this.selecaoCheckbox.length);
		statusBotaoAcao.call(this, selecaoCheckboxChegados.length);
	}
